import NonClickableParentWithSubMenu from './NonClickableParentWithSubMenu'
...
const VerticalMenuContent = (props: VerticalMenuContentProps) => {
    ...
    const getNavItem = (nav: NavigationTree) => {
        ...
        if (nav.type === 'nonClickableParent') {
            return (
                <NonClickableParentWithSubMenu
                    key={nav.key}
                    nav={nav}
        ...
        if (!hasSubMenu && nav.type === NAV_ITEM_TYPE_ITEM) {
            return (
        ...
        if (hasSubMenu && nav.type === NAV_ITEM_TYPE_COLLAPSE) {
            return (
